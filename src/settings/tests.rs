...
fn test_calc_entropy() {
    let table = [
        // AppleID: padding_symbol_lengths=(1,1) → 2 symbol choices, seen increased by log2(4)=2
        ...
        // Web16: padding_symbol_lengths=(1,1) → 2 symbol choices, seen increased by log2(13)≈3.7
        ((Preset::Web16, 1113), (102, 102, 44), (557, 10, 8)),
        // Web32: padding_symbol_lengths=(1,1) → 2 symbol choices, seen increased by log2(13)≈3.7
        ((Preset::Web32, 2493), (177, 203, 69), (1_000_000_001, 0, 0)),
        // Wifi: padding_symbol_lengths=(0,0) → 0 symbol choices, seen now correctly excludes symbol entropy
